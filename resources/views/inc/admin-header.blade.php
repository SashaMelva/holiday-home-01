        ...
        <ul class="navbar-nav flex-column" id="navbar-sidebar">
            ...
            <li class="nav-item">
                ...
                <ul class="nav collapse flex-column" id="collapseguest"
                    data-bs-parent="#navbar-sidebar">
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.history') }}">Администраторы</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.history.guests') }}">Клиеты</a></li>
                    <li class="nav-item"><a class="nav-link" href="{{ route('admin.history.agents') }}">Агенты</a></li>
                </ul>
            </li>
            <!-- Menu item -->
