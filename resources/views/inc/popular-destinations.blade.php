    ...
    <div class="row p-4 container-popular">
        <article class="card-city p-4 shadow rounded-3">
            ...
            <div class="card-body">
                ...
                <a href="#" class="btn btn-primary">Просмотреть отели</a>
            </div>
        </article>
        <article class="card-city p-4 shadow rounded-3">
        ...
        <article class="card-city p-4 shadow rounded-3">
            <img src="{{ Vite::asset('resources/img/popular-city/Kaliningrad.jpg') }}" class="card-img-top" alt="...">
            <div class="card-body">
                <h5 class="card-title">Калининград</h5>
                <p class="card-text">Калининградская область уникальна своим расположением: она не граничит с другими
                    регионами России, соседствует лишь с Литвой и Польшей.</p>
                <a href="#" class="btn btn-primary">Просмотреть отели</a>
            </div>
        </article>
    </div>
