                                    ...
                                    <div class="card-body">
                                        <div class="row g-3">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <h6 class="mb-0">{{ $userData['surname'] }} {{ $userData['name'] }} {{ $userData['patronymic'] }}</h6>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="tab-pane fade" id="tab-2" role="tabpanel">
                        ...
                        <div class="card border">
                            ...
                            <div
                                ...
                                <!-- Button -->
                                <div class="mt-2 mt-md-0">
                                    <a href="#" class="btn btn-primary-soft mb-0">Менеджер бронирования</a>
                    ...
                    <div class="tab-pane fade" id="tab-3" role="tabpanel">
                        ...
                        <div class="card border">
                            ...
                            <div
                                ...
                                <!-- Button -->
                                <div class="mt-2 mt-md-0">
                                    <a href="#" class="btn btn-primary-soft mb-0">Оставте отзыв об отеле</a>
