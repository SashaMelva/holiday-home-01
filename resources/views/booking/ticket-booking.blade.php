                ...
                <div class="card shadow m-tb-1">
                    ...
                    <div class="card-body text-center p-4">
                        ...
                        <div class="d-sm-flex justify-content-sm-end d-grid">
                            ...
                            <!-- Download button -->
                            <a href="{{route('booking.ticket', $booking->id)}}" class="btn btn-primary mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-file-pdf" viewBox="0 0 16 16">
