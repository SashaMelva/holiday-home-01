        ...
        <div id="stepper" class="bs-stepper stepper-outline">
            ...
            <div class="bs-stepper-content p-0 pt-4 pt-md-5">
                <div class="row g-4">
                    ...
                    <!-- Main content START -->
                    <div class="col-12">
                        <form method="POST" action="{{ route('hotel.information.update', $hotel->id) }}">
                            @csrf
                                    ...
                                    <div class="card-body m-tb-1">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select id="category_id" name="category_id" class="form-select"
                                                    ...
                                                    @foreach($typeHotels as $typeHotel)
                                                        <option @if($hotel->type == $typeHotel->id) selected
                                                                @endif value="{{ $typeHotel->id }}">{{ $typeHotel->name }}</option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input id="full_title" name="full_title" class="form-control"
                                                       type="text"
                                                       placeholder="Гостиница Интурист-Краснодар в Краснодаре"
                                                       value="{{ $hotel->full_title }}" required>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input id="short_title" name="short_title" class="form-control"
                                                       type="text"
                                                       placeholder="Интурист-Краснодар"
                                                       value="{{ $hotel->short_title }}"
                                                       required>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="row g-4">
                                                    <!-- Total Floor -->
                                                    <div class="col-md-4">
                                                        <label for="number_rooms" class="form-label">Общее количество
                                                            номеров *</label>
                                                        <input id="number_rooms" name="number_rooms" type="text"
                                                               class="form-control" value="{{ $hotel->number_rooms }}"
                                                               required>
                                                    </div>

                                                    <!-- Total Floor -->
                                                    <div class="col-md-4">
                                                        <label for="star" class="form-label">Количество звёзд отеля
                                                            *</label>
                                                        <input id="star" name="star" type="text" class="form-control"
                                                               value="{{ $hotel->star }}" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row g-3">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <select id="city_id" name="city_id" class="form-select"
                                                            ...
                                                            @foreach($cities as $city)
                                                                <option @if($hotel->city_id == $city->id) selected
                                            ...
                                            <div class="col-12">
                                                ...
                                                <input id="address" name="address" class="form-control" type="text"
                                                       placeholder="Введите адресс" value="{{ $hotel->address }}"
                                                       required>
                                            </div>
                                        </div>
                                    </div>
